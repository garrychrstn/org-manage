...
@section('content')
    ...
    <div class="setup-form w-1/2 m-auto mt-16">
        <h1 class='text-2xl'>First, Create Division</h1>
        <form action="/mass-division" method="post" class="division">
            @csrf
            <input type='hidden' value='default' name='divs'>
            <button class="default-divisis block bg-slate-700 w-1/3 m-auto px-10 py-4 rounded-md text-white text-center" type='submit'>
        ...
        <form action='/mass-division' method='post' class='division'>
            ...
            <button class='px-2 py-1 bg-slate-400 text-white rounded'>submit</button>
        </form>
    </div>
@endsection
